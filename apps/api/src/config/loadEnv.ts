...
export function loadServerEnv(): ParsedEnv {
  ...
  const raw = {
    ...
    SUPPORT_NOTIFICATIONS_TABLE: process.env.SUPPORT_NOTIFICATIONS_TABLE,
    SUPPORT_NOTIFICATION_RULES_TABLE: process.env.SUPPORT_NOTIFICATION_RULES_TABLE,
    SUPPORT_AUTH_TOKENS_TABLE: process.env.SUPPORT_AUTH_TOKENS_TABLE,
